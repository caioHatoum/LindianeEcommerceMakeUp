...
using LindianeEcommerceMakeUp.Models;
...
namespace LindianeEcommerceMakeUp.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult DropDownMenuCategoria()
        {
            IEnumerable<CategoriaProduto> listaCategoria = Repositorio.CategoriaProduto.ToList();
